...
set_dont_touch [get_cells {u_dco}] true
...
#streamOut ${TOP_DESIGN}.gds -mapFile /home/m110/m110061576/process/CBDK_TSMC018_Arm_f1.0/CIC/SOCE/streamOut.map -libName DesignLib -structureName ${TOP_DESIGN} -stripes 1 -units 1000 -mode ALL
